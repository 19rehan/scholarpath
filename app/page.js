      ...
      <div style={{ minHeight: '100vh', background: '#ffffff' }}>
        ...
        {showProfilePopup && (
          <div onClick={closePopup} style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, zIndex: 9999, background: 'rgba(15, 23, 42, 0.6)', backdropFilter: 'blur(8px)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
            <div onClick={e => e.stopPropagation()} style={{ background: 'white', borderRadius: '17px', maxWidth: '320px', width: '100%', overflow: 'hidden', boxShadow: '0 32px 80px rgba(0,0,0,0.25)', animation: 'popupIn 0.4s cubic-bezier(0.4, 0, 0.2, 1) forwards' }}>
              <div style={{ background: 'linear-gradient(135deg, #4f46e5, #7c3aed)', padding: '24px 20px 20px', position: 'relative' }}>
